...
import  ExtensionManager  from 'resource:///org/gnome/shell/ui/main/extensionManager.js';
...
//const _ = text.domain('arch-update');
...
export default class ArchUpdateIndicatorExtension {
	enable() {
