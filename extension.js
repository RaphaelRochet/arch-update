		...
		this.ArchUpdateIndicator =  GObject.registerClass(
			...
			class ArchUpdateIndicator extends Button {
				...
				_getCustIcon(icon_name) {
					...
					return Gio.icon_new_for_string( gSettings.dir.get_child('icons').get_path() + "/" + icon_name + ".svg" );
				}
				...
				_showNotification(title, message) {
					if (this._notifSource == null) {
						...
						this._notifSource.createIcon = function() {
							let gicon = Gio.icon_new_for_string( gSettings.dir.get_child('icons').get_path() + "/arch-updates-logo.svg" );
